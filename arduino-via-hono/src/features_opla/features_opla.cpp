...
Feature ledsFeature() {
  return Feature("leds", std::vector<String> {"org.eclipse.ditto.examples.arduino.carrier:LEDs:1.0.0"})
...
Feature lightFeature() {
  return Feature("light", std::vector<String> {"org.eclipse.ditto.examples.arduino.carrier:Light:1.0.0", "org.eclipse.ditto.examples.arduino.carrier:Gesture:1.0.0"})
...
Feature buzzerFeature() {
  return Feature("buzzer", std::vector<String> {"org.eclipse.ditto.examples.arduino.carrier:Buzzer:1.0.0"})
...
Feature accelerationFeature() {
  return Feature("acceleration", std::vector<String> {"org.eclipse.vorto.std.sensor:AccelerationSensor3D:1.0.0"})
...
Feature displayFeature() {
  return Feature("display", std::vector<String> {"org.eclipse.ditto.examples.arduino.carrier:ColoredDisplay:1.0.0"})
